            ...
            <div className="bg-white p-3 rounded-4">
              ...
              <a href="" className="text-decoration-none">
                <small className=" text-dark">
                  <FaMapMarkerAlt size="20" style={{ color: "red" }} /> Jl. Kini
                  Balu No.16, Bilaporah, Socah, Kabupaten Bangkalan, Jawa Timur
                  69116, Area Sawah/Kebun, Bilaporah, Kec. Socah, Kabupaten
              ...
              <h4 className="fw-bold">
                Service komputer, laptop, printer dan toko peralatan komputer
              </h4>
              ...
              <div className="row p-3 gap-3">
                <div className="col p-3 bg-DCE8FF rounded-3 max-content">
                  ...
                  <div className="d-flex gap-2">
                    ...
                    <p>
                      Melayani pembelian kebutuhan komputer, laptop, dan printer
                    </p>
                  </div>
                  <div className="d-flex gap-2">
                ...
                <div className="col p-3 bg-DCE8FF rounded-3 max-content">
                  ...
                  <div className="d-flex gap-2">
                    <p className="px-2 rounded-circle bg-primary max-content text-white">
                      1
                    </p>
