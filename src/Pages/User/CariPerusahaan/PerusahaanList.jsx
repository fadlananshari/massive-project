...
const PerusahanList = [
  {
    ...
    tempat: "Aulia Computer",
    lokasi: "Griya abadi  - bangkalan",
    url: ["/pendaftaran/1", "/detail-perusahaan/:id"],
    gambar: Gambar1,
  },
  {
    nama: "Service & Store Komputer",
    tempat: "Abdi IT Service",
    lokasi: "Kamal - Bangkalan",
    url: ["/pendaftaran/1", "/detail-perusahaan/:id"],
    gambar: Gambar2,
  },
  {
    nama: "Service Komputer & printer",
    tempat: "Sejati Komputer",
    lokasi: "Mlajah - Bangkalan",
    url: ["/pendaftaran/1", "/detail-perusahaan/:id"],
    gambar: Gambar3,
  },
  {
    nama: "Service & Store Komputer",
    tempat: "DNA Komputer",
    lokasi: "Hi-Tech Mall - Surabaya",
    url: ["/pendaftaran/1", "/detail-perusahaan/:id"],
    gambar: Gambar4,
  },
  {
    nama: "Service Komputer & Printer",
    tempat: "Bengkel Komputer",
    lokasi: "Hi-Tech Mall - Surabaya",
    url: ["/pendaftaran/1", "/detail-perusahaan/:id"],
    gambar: Gambar5,
  },
